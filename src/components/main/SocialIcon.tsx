...
export default function SocialIcon({ id }: { id: string }) {
  ...
  switch (id) {
    ...
    case 'threads':
      return (
        <svg {...common}>
          <path d="M12.2 22c-2.9 0-5.2-1-6.7-2.9C4.2 17.4 3.5 15.1 3.5 12.3v-.1c0-2.9.7-5.2 2-6.9C7 3.5 9.3 2.5 12.2 2.5c2.5 0 4.6.8 6.1 2.3l-1.4 1.4c-1.1-1.2-2.7-1.8-4.7-1.8-2.2 0-3.9.7-5 2.1-1 1.3-1.6 3.2-1.6 5.7v.1c0 2.4.6 4.3 1.6 5.6 1.1 1.4 2.8 2.1 5 2.1 1.9 0 3.4-.5 4.4-1.4.9-.8 1.3-1.9 1.3-3.1 0-1-.4-1.9-1.1-2.5-.6.5-1.4.9-2.4 1.1-.3 2.3-1.6 3.7-3.7 3.7-1 0-1.9-.3-2.6-.9-.7-.6-1.1-1.4-1.1-2.3 0-1 .5-1.9 1.4-2.5.8-.5 1.9-.8 3.2-.8.7 0 1.4.1 2 .2-.1-.8-.4-1.3-.8-1.7-.5-.4-1.2-.6-2.1-.6-1.1 0-2 .4-2.7 1.1l-1.4-1.3c1-1.1 2.4-1.7 4.1-1.7 1.4 0 2.6.4 3.5 1.2.8.8 1.3 1.9 1.5 3.2 1.6.9 2.4 2.3 2.4 4.1 0 1.8-.7 3.3-2 4.5-1.4 1.2-3.3 1.8-5.6 1.8zm-.9-7.1c-1.5 0-2.6.5-2.6 1.4 0 .8.9 1.3 1.8 1.3 1.3 0 2-.7 2.1-2.5-.4-.1-.9-.2-1.3-.2z" />
        </svg>
      );
    default:
      return (
