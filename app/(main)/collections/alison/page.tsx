...
export default async function AlisonPage() {
  ...
  return (
    <>
      ...
      <PhotoGrid items={items.map((a) => ({ ...pictureData(a.imagePath), id: `alison-${a.id}`, alt: `${a.title}, ${a.description}`, caption: a.description }))} size="sm" sizes="(min-width: 900px) 180px, 33vw" fit="natural" />
    </>
  );
}
